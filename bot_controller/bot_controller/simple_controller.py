...
class SimpleController(Node):
    ...
    def jointCallback(self, msg):
        ...
        # --- CÁLCULOS ---
        # rotational speed
        fi_left = dp_left/(dt.nanoseconds/S_TO_NS) # rad/s
        fi_right = dp_right/(dt.nanoseconds/S_TO_NS) # rad/s
        ...
        #self.get_logger().info("x: %f, y: %f, t: %f" %(self.x_, self.y_, self.theta_))
